...
define config.name = _("MorningStaring")
...
define config.version = "alpha0.3"
...
define build.name = "MorningStaring"


## 음악과 음향 ######################################################################

## 이 세 가지 변수는 기본적으로 플레이어에 표시되는 믹서를 제어합니다. 이들 중
## 하나를 False로 설정하면 해당 믹서가 숨겨집니다.
...
define config.save_directory = "MorningStaring-1610290312"
